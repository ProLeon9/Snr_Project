...
public class LLE extends ReduceDimensionToolBox{
    //曲线相关参数
    private Curve curve;
    //显示进度相关参数
    ...
    public ChartPanel excuteReduceDimesion(ReduceDimensionPCAAndLLEAndKPCAAndReduceNoiceSSAAndICA reduceDimensionPCAAndLLEAndKPCAAndReduceNoiceSSAAndICA, String resultPath, String lastMethod, String matlabPath) throws Exception{
        ...
        BufferedWriter resultWriter = new BufferedWriter(new FileWriter(resultPath+"\\LLE_old.txt"));
        ...
        //计算SNR和PI-----------------
        BufferedReader oldCurveReader = new BufferedReader(new FileReader(resultPath+"\\LLE_old.txt"));
        BufferedReader resultReader = new BufferedReader(new FileReader(resultPath+"\\LLE.txt"));
        ...
        super.resultChartPanel = xyLineChart.getChart("LLE Result", "Sample", "Value", xyDataset, true);
    ...
    private void getParametersFromPanel(ReduceDimensionPCAAndLLEAndKPCAAndReduceNoiceSSAAndICA reduceDimensionPCAAndLLEAndKPCAAndReduceNoiceSSAAndICA){
        ...
        this.curve.reduceDimension = Integer.parseInt(reduceDimensionPCAAndLLEAndKPCAAndReduceNoiceSSAAndICA.character_number_textfield.getText());
    }

    private void excuteMatlabScript(String resultPath, String matlabPath) throws IOException{
        String comstr = matlabPath+" -nosplash -nodesktop -nodisplay -r \""+"wavePath=\'"+resultPath+"\\"+"\',N="+this.curve.reduceDimension+";"+"runlle\"";
